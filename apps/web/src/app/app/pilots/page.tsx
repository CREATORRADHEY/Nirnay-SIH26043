    ...
    <AppShell>
      <div className="space-y-6">
        <div className="bg-white p-6 rounded-xl border border-stone-200 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-stone-900">Pilot Operational State Workspace</h1>
            <p className="text-sm text-stone-600 mt-1">Active pilot projects, operational state transitions, and evidence plans.</p>
          </div>
          <Link
            href="/app/review"
