...
from app.api.v1.jury_evaluation import router as jury_evaluation_router
...
api_v1_router.include_router(ai_evaluation_router)
api_v1_router.include_router(jury_evaluation_router)
